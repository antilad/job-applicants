...
//]]></script><script async src="js/browser-sync-client.js"></script>
	...
	// Take search term and assign to variable
	$searchTerm = $_POST['searchTerm'];
	// If the query is empty change variable to the string 'nothing'
	if (empty($searchTerm)) {
		$searchTerm = 'nothing';
	}
	// Remove spaces from query and assign to variable to use in search by name
...
<main id="content" role="main">
  ...
  <div class="grid-row">
    <div class="column-two-thirds">
      ...
      <p>You searched for <?php echo $searchTerm . ' ' . $searchType ?>.</p>
	  ...
	  if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        if(mysqli_num_rows($data)>0) {
          // Loop through array and open list tag
      ...
      <p>Alternatively you can try another search using the Applicant Search function.</p>
